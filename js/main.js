...
function initSkillRotator() {
  const el = document.getElementById('about-skill-rotator');
  if (!el) return;

  const SKILLS = [
    'Immersive Attractions', 'Title Sequences', 'Brand Platforms',
    'AR Experiences', 'Museums', 'Video Games', 'Tangible Media',
